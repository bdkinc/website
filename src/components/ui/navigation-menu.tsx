...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{' '}
      <PiCaretDown
        className="relative top-[1px] ml-1 size-3 transition duration-300 group-data-[open]:rotate-180 group-data-[state=open]:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
...
function NavigationMenuViewport({
  ...
  return (
    <NavigationMenuPrimitive.Viewport
      ...
      className={cn('origin-top-center w-full md:w-auto', className)}
      {...props}
    />
  );
}
