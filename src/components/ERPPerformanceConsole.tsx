      ...
      <div className="border-primary/20 bg-card/40 mb-8 flex flex-col gap-6 rounded-none border p-6 backdrop-blur-sm md:flex-row md:items-center md:justify-between">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-8">
          {systemStats.map((stat) => (
            ...
            >
              <div className="text-muted-foreground mb-1 font-mono text-[10px] tracking-widest">
                {stat.label}
              </div>
          ...
          >
            <div className="relative z-10 flex h-full flex-col p-6 text-left">
              <div className="mb-6 flex items-start justify-between">
                <div className="bg-primary/10 ring-primary/20 group-hover:bg-primary/20 group-hover:ring-primary/40 flex h-12 w-12 items-center justify-center rounded-lg ring-1 transition-[color,background-color,border-color,box-shadow,opacity,transform,width,gap,letter-spacing] duration-300 group-hover:scale-110">
