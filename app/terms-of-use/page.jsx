    ...
    <div className="py-4">
      <main className="container">
        ...
        <div className="prose lg:prose-lg xl:prose-xl dark:text-slate-100">
          <p>Welcome to BDKinc!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of B. Donald Kimball, Inc.'s Website, located at
            https://www.bdkinc.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use BDKinc if you do not agree to
          ...
          {/*<p>*/}
          {/*  We employ the use of cookies. By accessing BDKinc, you agreed to use*/}
          {/*  cookies in agreement with the B. Donald Kimball, Inc.'s Privacy*/}
          {/*  Policy.{" "}*/}
          {/*</p>*/}
          ...
          <p>
            Unless otherwise stated, B. Donald Kimball, Inc. and/or its
            licensors own the intellectual property rights for all material on
            BDKinc. All intellectual property rights are reserved. You may
            access this from BDKinc for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from BDKinc</li>
            <li>Sell, rent or sub-license material from BDKinc</li>
            <li>Reproduce, duplicate or copy material from BDKinc</li>
            <li>Redistribute content from BDKinc</li>
          </ul>
          ...
          <p>
            ...
            B. Donald Kimball, Inc. does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of B. Donald Kimball, Inc.,its agents
            ...
            applicable laws, B. Donald Kimball, Inc. shall not be liable for the
          ...
          <p>
            B. Donald Kimball, Inc. reserves the right to monitor all Comments
          ...
          <p>
            You hereby grant B. Donald Kimball, Inc. a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of B. Donald
            Kimball, Inc.; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to B. Donald Kimball, Inc.. Please include your
          ...
          <p>
            No use of B. Donald Kimball, Inc.'s logo or other artwork will be
